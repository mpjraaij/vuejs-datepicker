(function (global, factory) {
  ...
  (global = global || self, global.vuejsDatepicker = factory(global.format));
}(this, function (format) { 'use strict';
  ...
  var script$4 = {
    ...
    methods: {
      ...
      parseDateToShow: function parseDateToShow(date) {
        return format(new Date(date.getFullYear(), date.getMonth(), date.getDate()), 'dd-MM-yyyy'); // return date.getDate() + '-' + (date.getMonth() + 1) + '-' + date.getFullYear()
      },
      parseDateToSend: function parseDateToSend(date) {
      ...
      [
        _c("div", { staticClass: "header" }, [
          _c("div", { staticClass: "header-section" }, [
            ...
            _vm._v(" "),
            _vm.highlighted.from
              ? _c("span", [
                  _c(
                    "span",
                    {
                      staticClass: "header-section__date",
                      on: {
                        click: function($event) {
                          return _vm.$emit("change", "from")
                        }
                      }
                    },
                    [_vm._v(_vm._s(_vm.parseDateToShow(_vm.highlighted.from)))]
                  ),
                  _vm._v(" "),
                  _c("a", {
                    staticClass: "header-section__clear",
                    attrs: { href: "#" },
                    on: {
                      click: function($event) {
                        return _vm.$emit("clear", "from")
                      }
                    }
                  })
                ])
              ...
              ? _c("span", [
                  _c(
                    "span",
                    {
                      ...
                      on: {
                        click: function($event) {
                          return _vm.$emit("change", "to")
                        }
                      }
                    },
                    [_vm._v(_vm._s(_vm.parseDateToShow(_vm.highlighted.to)))]
                  ),
                  _vm._v(" "),
                  _c("a", {
                    staticClass: "header-section__clear",
