(function (global, factory) {
  ...
  (global = global || self, global.vuejsDatepicker = factory(global.dateFns));
  ...
  var script$4 = {
    ...
    methods: {
      ...
      parseDateToShow: function parseDateToShow(date) {
        return dateFns.format(date, this.format); // return date.getDate() + '-' + (date.getMonth() + 1) + '-' + date.getFullYear()
      },
